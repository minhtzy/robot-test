...
from robot_testkit.targets import describe_profile_targets, select_nodes
...
def test_profile_describes_build_lint_nodes_services_and_topics() -> None:
    ...
    targets = describe_profile_targets(profile)
...
def test_build_and_lint_use_profile_packages_in_dry_run() -> None:
    ...
    assert "--packages-select project_client project_robot_control project_arm_control" in build_command
